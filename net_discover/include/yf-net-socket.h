#ifndef YFNETSOCKET_H
#define YFNETSOCKET_H

#include <string>

#ifdef WIN32

#ifdef	YFNETSOCKET_EXPORTS
#define YFDLL_YFNETSOCKET_API __declspec(dllexport) bool __stdcall
#else
#define YFDLL_YFNETSOCKET_API __declspec(dllimport) bool __stdcall
#endif
